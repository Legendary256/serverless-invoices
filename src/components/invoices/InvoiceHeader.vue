<template>
    <div>
        ...
        {{ $t('issued_at') }}
        <span class="editable__item" v-b-modal.modal_issued_at>{{ invoice.issued_at | date('DD/MM/YYYY', 'YYYY-MM-DD') }}</span>
        ...
        <span class="editable__item"
              v-b-modal.modal_due_at>{{ invoice.due_at | date('DD/MM/YYYY', 'YYYY-MM-DD') }}</span>
